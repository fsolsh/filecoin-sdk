...
import com.fsolsh.mining.filecoin.exception.AddressException;
import com.fsolsh.mining.filecoin.utils.AddressUtil;
...
public class TransactionHandler {
     ...
     * 形成摘要需要拼接的字符串
     */
    private final byte[] CID_PREFIX = new byte[]{0x01, 0x71, (byte) 0xa0, (byte) 0xe4, 0x02, 0x20};
